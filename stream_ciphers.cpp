...
char*decode(char *ciphertext, unsigned long key) {
	...
	{
		unsigned int c;
	c = (static_cast<unsigned int>(ciphertext[5*n])-33)*pow(85,4) +
			(static_cast<unsigned int>(ciphertext[5*n+1])-33)*pow(85,3) +
			(static_cast<unsigned int>(ciphertext[5*n+2])-33)*pow(85,2) +
			(static_cast<unsigned int>(ciphertext[5*n+3])-33)*pow(85,1) +
			(static_cast<unsigned int>(ciphertext[5*n+4])-33);
